...
/obj/machinery/door/airlock/cult/allowed(mob/living/L)
	...
	if(friendly || iscultist(L) || istype(L, /mob/living/simple_animal/shade) || isconstruct(L))
		...
		if(!stealthy)
			...
			SEND_SOUND(L, sound(pick('sound/hallucinations/turn_around1.ogg','sound/hallucinations/turn_around2.ogg'),0,1,50, volume = 100 * L.client.prefs.channel_volume["[CHANNEL_MACHINERY]"]))
